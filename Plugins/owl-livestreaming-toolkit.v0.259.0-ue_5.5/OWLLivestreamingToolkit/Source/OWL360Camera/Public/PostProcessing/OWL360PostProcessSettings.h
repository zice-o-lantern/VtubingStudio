...
struct FOWL360RenderingFeaturesPathTracingSettings
{
	...
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features|PathTracing", meta = (ClampMin = "-10.0", ClampMax = "30.0", editcondition = "bOverride_PathTracingMaxPathIntensity", DisplayName = "Max Path Exposure"))
...
struct FOWL360RenderingFeaturesSettings
{
	...
	UPROPERTY(interp, BlueprintReadWrite, Category = "Rendering Features", meta = (editcondition = "bOverride_bMegaLights", DisplayName = "MegaLights"))
	bool bMegaLights = true;
