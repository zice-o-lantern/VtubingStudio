...
class OWLMRQPIPELINE_API FOWL360CameraStereoVR180Blender : public FOWL360CameraBlenderBase
{
public:
	FOWL360CameraStereoVR180Blender(TSharedPtr<MoviePipeline::IMoviePipelineOutputMerger> InOutputMerger, const FIntPoint InOutputResolution, const bool bEnableAlpha);
