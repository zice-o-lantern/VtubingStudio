...
class OWLMRQPIPELINE_API FOWL360CameraResizeCubemapBlender : public FOWL360CameraBlenderBase
{
public:
	FOWL360CameraResizeCubemapBlender(TSharedPtr<MoviePipeline::IMoviePipelineOutputMerger> InOutputMerger, const FIntPoint InOutputResolution, const bool bEnableAlpha);
...
private:
	int GetFaceIndexFromUV(FVector2d InUV);
};
