...
enum class E360ProjectionType : uint8 {
	...
	CT_Mono180 UMETA(DisplayName = "Mono 180 Equirectangular"),
	CT_DomeMaster UMETA(DisplayName = "DomeMaster"),
	CT_MirrorDome UMETA(DisplayName = "Mirror Dome", ToolTip="A mirror dome shader for projecting a 2D image on a spherical mirror")
};
...
public:
	...
	*/
	...
	/** Enable path tracing */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Off World Live Capture Settings|Advanced", meta = (EditCondition="IsRayTracingEnabled()"))
